        ...
        <Components.Container>
            <Components.SignUpContainer signinIn={signIn}>
                <Components.Form>
                    ...
                    <Components.Button onClick={() => navigate("/uploader")}>Sign Up</Components.Button>
                </Components.Form>
            ...
            <Components.SignInContainer signinIn={signIn}>
                <Components.Form>
                    ...
                    <Components.Button onClick={() => navigate("/uploader")}>Sigin In</Components.Button>
                </Components.Form>
            ...
            <Components.OverlayContainer signinIn={signIn}>
                <Components.Overlay signinIn={signIn}>
                    <Components.LeftOverlayPanel signinIn={signIn}>
                        ...
                        <Components.GhostButton onClick={() => toggle(true)} style={{width:'214px'}}>
                            Sign In
                    ...
                    <Components.RightOverlayPanel signinIn={signIn}>
                        ...
                        <Components.GhostButton onClick={() => toggle(false)} style={{width:'214px'}}>
                            Sign Up
                        </Components.GhostButton>
                        <br />
                        <Components.GhostButton onClick={() => navigate("/")}>
